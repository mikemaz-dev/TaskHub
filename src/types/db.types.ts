...
export type Database = {
	...
	public: {
		...
		Functions: {
			...
			taskhub_create_invite: { Args: { project_input: string }; Returns: string }
			taskhub_set_member_role: {
				Args: { project_input: string; profile_input: string; role_input: string }
				Returns: undefined
			}
			taskhub_remove_member: {
				Args: { project_input: string; profile_input: string }
				Returns: undefined
			}
			taskhub_project_state: {
				Args: { project_input: string; action_input: string }
				Returns: undefined
			}

			taskhub_accept_project_invite: { Args: { code_input: string }; Returns: string }
